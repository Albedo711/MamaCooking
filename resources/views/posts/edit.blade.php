                ...
                <div class="card border-0 shadow-sm rounded">
                    ...
                    <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('Bahan') is-invalid @enderror" name="Bahan" rows="5" placeholder="Masukkan Bahan">{{ old('Bahan', $post->Bahan) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('Tutorial') is-invalid @enderror" name="Tutorial" rows="5" placeholder="Masukkan Tutorial">{{ old('Tutorial', $post->Tutorial) }}</textarea>
